"""
Django settings for django_ravepay project.
...
SECRET_KEY = "^8tme12xj)5ak1n&x%ay#fq&zhs&g-hiuo-ay)+%s(j7#(b@lh"
...
ROOT_URLCONF = "django_ravepay.urls"
...
WSGI_APPLICATION = "django_ravepay.wsgi.application"
