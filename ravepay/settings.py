...
import os
RAVEPAY_SECRET_KEY = getattr(settings, "RAVEPAY_SECRET_KEY", os.getenv("RAVEPAY_SECRET_KEY",""))
RAVEPAY_PUBLIC_KEY = getattr(settings, 'RAVEPAY_PUBLIC_KEY', os.getenv("RAVEPAY_PUBLIC_KEY",""))
...
RAVEPAY_LIB_MODULE = getattr(
    settings, 'RAVEPAY_LIB_MODULE', 'ravepay.utils')